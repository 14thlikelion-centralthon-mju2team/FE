        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _TimeRow(
                label: "준비 시작",
                time: timeFormat.format(plan.prepStartAt),
              ),
              _TimeRow(
                label: "권장 출발",
                time: timeFormat.format(plan.recommendedDepartAt),
              ),
              _TimeRow(
                label: "도착 예상",
                time: timeFormat.format(plan.targetArriveAt),
              ),
              ...
              Wrap(
                ...
                children: [
                  ...
                  OutlinedButton(
                    onPressed: onSnooze,
                    child: const Text("5분 뒤 알림"),
                  ),
                  OutlinedButton(
                    onPressed: onSelectRoute,
                    child: const Text("경로 확인"),
                  ),
...
class _BreakdownSummary extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final total =
        breakdown.estimatedPrepMinutes +
